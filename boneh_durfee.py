...
def boneh_durfee_attack(N, e, factor_bit_length, partial_p=None, delta=0.25, m=1, t=None):
    """
    ...
    :return: a tuple containing the prime factors and the private exponent d, or None if not found
    """
...
if __name__ == "__main__":
    ...
    p, q, d = boneh_durfee_attack(N, e, p_bits, delta=delta, m=3)
    assert p * q == N
